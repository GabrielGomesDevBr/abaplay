-- Migration 003: Expansão do Cadastro de Pacientes (CORRIGIDA)
-- Data: Setembro 2025
...
-- Adicionar novos campos opcionais à tabela patients (um por vez)
...
ALTER TABLE patients ADD COLUMN guardian_occupation VARCHAR(255);
ALTER TABLE patients ADD COLUMN guardian_education VARCHAR(255);

-- Segundo Responsável (pai/mãe)
ALTER TABLE patients ADD COLUMN second_guardian_name VARCHAR(255);
ALTER TABLE patients ADD COLUMN second_guardian_relationship VARCHAR(100);
ALTER TABLE patients ADD COLUMN second_guardian_phone VARCHAR(20);
ALTER TABLE patients ADD COLUMN second_guardian_email VARCHAR(255);
ALTER TABLE patients ADD COLUMN second_guardian_occupation VARCHAR(255);

-- Dados de Endereço
ALTER TABLE patients ADD COLUMN address_street TEXT;
ALTER TABLE patients ADD COLUMN address_number VARCHAR(10);
ALTER TABLE patients ADD COLUMN address_complement VARCHAR(100);
ALTER TABLE patients ADD COLUMN address_neighborhood VARCHAR(100);
ALTER TABLE patients ADD COLUMN address_city VARCHAR(100);
ALTER TABLE patients ADD COLUMN address_state VARCHAR(2);
ALTER TABLE patients ADD COLUMN address_zip VARCHAR(9);

-- Dados Educacionais
ALTER TABLE patients ADD COLUMN school_name VARCHAR(255);
ALTER TABLE patients ADD COLUMN school_phone VARCHAR(20);
ALTER TABLE patients ADD COLUMN school_email VARCHAR(255);
ALTER TABLE patients ADD COLUMN school_teacher VARCHAR(255);
ALTER TABLE patients ADD COLUMN school_teacher_phone VARCHAR(20);
ALTER TABLE patients ADD COLUMN school_grade VARCHAR(50);
ALTER TABLE patients ADD COLUMN school_period VARCHAR(20); -- manhã, tarde, integral
ALTER TABLE patients ADD COLUMN school_special_needs BOOLEAN DEFAULT false;
ALTER TABLE patients ADD COLUMN school_adaptations TEXT;

-- Dados de Nascimento e Desenvolvimento
ALTER TABLE patients ADD COLUMN birth_weight DECIMAL(5,3);
ALTER TABLE patients ADD COLUMN birth_height DECIMAL(5,2);
ALTER TABLE patients ADD COLUMN birth_complications TEXT;
ALTER TABLE patients ADD COLUMN gestational_age INTEGER; -- em semanas
ALTER TABLE patients ADD COLUMN delivery_type VARCHAR(20); -- normal, cesariana
ALTER TABLE patients ADD COLUMN development_concerns TEXT;
ALTER TABLE patients ADD COLUMN early_intervention BOOLEAN DEFAULT false;

-- Dados Médicos Gerais
ALTER TABLE patients ADD COLUMN pediatrician_name VARCHAR(255);
ALTER TABLE patients ADD COLUMN pediatrician_phone VARCHAR(20);
ALTER TABLE patients ADD COLUMN pediatrician_email VARCHAR(255);
ALTER TABLE patients ADD COLUMN health_insurance VARCHAR(255);
ALTER TABLE patients ADD COLUMN health_insurance_number VARCHAR(100);

-- Observações Especiais
ALTER TABLE patients ADD COLUMN allergies TEXT;
ALTER TABLE patients ADD COLUMN dietary_restrictions TEXT;
ALTER TABLE patients ADD COLUMN behavioral_notes TEXT;
ALTER TABLE patients ADD COLUMN communication_preferences TEXT;

-- Metadados
ALTER TABLE patients ADD COLUMN expanded_data_completed BOOLEAN DEFAULT false;
ALTER TABLE patients ADD COLUMN expanded_data_completed_by INTEGER REFERENCES users(id);
ALTER TABLE patients ADD COLUMN expanded_data_completed_at TIMESTAMP WITH TIME ZONE;
