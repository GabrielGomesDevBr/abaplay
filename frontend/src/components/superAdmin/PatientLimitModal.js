...
import { faTimes, faEdit, faSpinner, faCheck, faUsers, faExclamationTriangle } from '@fortawesome/free-solid-svg-icons';

const PatientLimitModal = ({ isOpen, onClose, clinic, onSubmit }) => {
