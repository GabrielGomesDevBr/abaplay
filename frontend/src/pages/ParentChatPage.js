    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-5xl mx-auto px-2 sm:px-3 lg:px-4 py-3 sm:py-4 lg:py-6">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg overflow-hidden border border-gray-100">
          {/* Header do chat */}
          <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-700 px-4 sm:px-6 lg:px-8 py-4 sm:py-6 relative overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <p className="text-blue-100 text-xs sm:text-sm leading-relaxed px-2">
                Converse diretamente com todos os terapeutas de {selectedPatient.name}
              </p>

              <div className="mt-3 sm:mt-4 flex items-center justify-center space-x-3 sm:space-x-6 text-blue-100 text-xs sm:text-sm flex-wrap gap-y-2">
